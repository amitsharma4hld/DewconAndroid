...
public abstract class Hilt_PoliceBackupFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PoliceBackupFragment() {
    super();
  }

  Hilt_PoliceBackupFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PoliceBackupFragment_GeneratedInjector) this.generatedComponent()).injectPoliceBackupFragment(UnsafeCasts.<PoliceBackupFragment>unsafeCast(this));
    }
  }
