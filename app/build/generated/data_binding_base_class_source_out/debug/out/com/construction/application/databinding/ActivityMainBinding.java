...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView,
      @NonNull FragmentContainerView fragmentNavHost, @NonNull Toolbar toolbar) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      FragmentContainerView fragmentNavHost = rootView.findViewById(id);
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, fragmentNavHost, toolbar);
    }
